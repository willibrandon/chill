...
const (
	...
	ipcNamespaceEnvironment = "CHILL_IPC_NAMESPACE"
	sampleRate              = 48_000
	channels                = 2
	sampleWidth             = 2
	interval                = 32_768
...
func isolatedEnvironment(root string) ([]string, string) {
	...
	overrides := []string{
		...
		ipcNamespaceEnvironment + "=" + filepath.Base(root),
		"CLICOLOR_FORCE=1",
		"COLORTERM=truecolor",
	}
	replaced := map[string]bool{
		"HOME": true, "USERPROFILE": true, "XDG_CONFIG_HOME": true, "APPDATA": true,
		"LOCALAPPDATA": true, "TMPDIR": true, "TMP": true, "TEMP": true,
		"NO_COLOR": true, ipcNamespaceEnvironment: true, "CLICOLOR_FORCE": true, "COLORTERM": true,
	}
